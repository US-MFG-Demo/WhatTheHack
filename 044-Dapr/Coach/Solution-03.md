...
<img Resources="../.img/Challenge-03/docker-rmq-output.png" style="zoom: 66%;padding-top: 50px;" />
...
1. First, you'll start the VehicleRegistrationService shown below:
   ...
   <img Resources="../.img/Challenge-03/dapr-setup-assignment03-vehichleregistration-highlight.png" style="padding-top: 25px;" />
...
1. Next, you'll start the FineCollectionService: 
   ...
   <img Resources="../.img/Challenge-03/dapr-setup-assignment03-finecollection-highlight.png" style="padding-top: 25px;" />
...
1. Next, you'll start the TrafficControlService:
   ...
   <img Resources="../.img/Challenge-03/dapr-setup-assignment03-trafficcontrol-highlight.png" style="padding-top: 25px;" />
...
1. Finally, you'll start the Traffic Simulator:
   ...
   <img Resources="../.img/Challenge-03/dapr-setup-assignment03-simulation-highlight.png" style="padding-top: 25px;" />
...
RabbitMQ provides a built-in dashboard that presents messaging activity, logging, and performance metrics. Open a browser and navigate to [http://localhost:15672/](http://localhost:15672/). Both the login name is `guest` and the password is `guest`. Shown below, the dashboard is helpful for troubleshooting RabbitMQ anomalies:
   ...
   <img Resources="../.img/Challenge-03/rabbitmq-dashboard.png" style="padding-top: 25px;" />
...
<img Resources="../.img/Challenge-03/service-bus-blade.png" style="zoom: 67%;padding-top: 30px;" />
